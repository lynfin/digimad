...
destinations = [
  ...
  { name: 'Diagonal Mar',
    phone: '93 567 76 37',
    desc: 'Do you know what a pop up store is? It’s a unique space where you can find special products and collections
      for limited time only. The Cube was designed to achieve two goals: on the one hand, letting new entrepreneurs as
        well as consolidated brands to show their products in an innovative and avant-garde environment. On the other hand,
        to offer a different and exclusive shopping experience to our customers.
  ...
  { name: 'Biblioteca Francesca Bonnemaison',
    phone: '932 687 360',
    desc: 'The public library system in Barcelona is quite easy to navigate – obtaining a library card is free and the
      book lending systems are relatively the same (you can take a book out for 3 weeks) and they even have laptop
      lending now as well! ',
    category: 'public',
  ...
  { name: 'Granja Petitbo',
    phone: '93 265 65 03',
    desc: 'Until the early 20th century, a city dairy farm (vaquería, where urbanites would go to get fresh milk) stood
      on this site. But times change, and it is now a Scandi-inspired café with an excellent design.
      To sum up, whenever you go, you could find yourself staying the whole day.',
    category: 'dining',
  ...
  { name: 'NeueHouse', desc: 'Dedicated Desks: $1,500 /month', category: 'coworking',
    image: 'https://www.neuehouse.com/wp-content/uploads/2020/02/NeueHouseMSQ_Gallery_Wide.jpg',
    website: 'https://neuehouse.com/', phone: '',
    address: { street1: '110 E 25th St', street2: '', zipcode: '10010', city: 'New York', state: 'NY', country: 'United States' } },
  { name: 'Green Desk', desc: 'Dedicated Desk: Starting $199/month', category: 'coworking',
    image: 'https://greendesk.com/wp-content/uploads/2022/01/68Jay-GD_16-7.jpg',
    website: 'https://www.greendesk.com/&sa=D&ust=1530701033696000', phone: '',
    address: { street1: '155 Water St', street2: 'Brooklyn', zipcode: '11201', city: 'New York', state: 'NY', country: 'United States' } },
  ...
  { name: 'Loews Chicago Hotel',
    phone: '312-840-6600',
    desc: 'Experience Chicago from the heart of the city. The luxurious Loews Chicago Downtown Hotel, situated steps from
    Navy Pier, offers guests spectacular city skyline and lake views while enjoying the comforts of home. Our top-rated
    luxury hotel in Downtown Chicago is ideally located near Magnificent Mile, and close to the citys most popular attractions
    including Millennium Park and the John Hancock Center.',
    category: 'lodging',
  ...
  { name: 'Millennium Park',
    phone: '',
    desc: 'ChicagoWiFi is free public wireless access available at City facilities throughout Chicago. Look for the network
    ChicagoWiFi or CPLWIFI on your device. No special settings, usernames or passwords are required. You will need to accept terms
    of use to connect to the network',
    category: 'public',
  ...
  { name: 'Chicago Public Library - Chinatown',
    phone: '(312) 747-8013',
    desc: 'A new 16,000-square-foot, two-story Chinatown Branch opened August 29, 2015 with a partially covered living
    roof, Feng shui-influenced interior design and expansive views of the city.',
    category: 'public',
  ...
  { name: 'Aurelios Pizza',
    phone: '(312) 374-4459',
    desc: 'Aurelios made its triumphant return to Chicago proper with this massive South Loop space that allows visitors
    to stretch out inside (or on the outdoor deck) and get to work.',
    category: 'dining',
