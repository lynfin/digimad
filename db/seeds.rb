...
destinations = [
  ...
  { name: '25N Coworking - Arlington Heights',
    desc: 'With modern design and full office amenities, 25N Coworking at Arlington Heights offers its member a great space to work at. The area is composed mostly of open spaces and offers a variety of different conference rooms catering to different needs. The staff here take coworking to a whole new level: professional, friendly and accomodating. The members commented that this space is truly a diamond in Chicago. If you want to expand your business circle, this is also the ideal option: plenty of networking events and activities are taking place here! 25N Coworking also has another location at 25 N River Ln, Geneva, IL 60134, a little further from downtown, but the amenities are just as great!', category: 'coworking', image: 'https://res.cloudinary.com/kisi-kloud/image/upload/c_lfill,dpr_auto,f_auto,q_auto:good,w_898/c_limit,w_752/v1/collections/cwr/coworking-locations/chicago/chicago-5b4f32a89894175cac5a1ded', website: 'https://www.25ncoworking.com/locations/arlington-heights-il/', phone: '(847) 600-4284', address: { street1: '3400 W. Stonegate Blvd. ', street2: '#101', zipcode: '60005', city: 'Arlington Heights', state: 'IL', country: 'United States' } },
  { name: 'Ampersand Cowork Logan Square',
    desc: 'Looking for vibrant atmosphere, helpful staff, comprehensive amenities at a reasonable price? You need look no further, Ampersand Cowork has them all. This gorgeous space is open and bright, offering a variety of seating options. At event days, the rooftop deck is peoples favorite spot for grilling and BBQ.',
    category: 'coworking',
    ...
    phone: '',
    address: { street1: '3317 West Fullerton Avenue', street2: '', zipcode: '60005', city: 'Chicago', state: 'IL',
               country: 'United States' } },
